...
nanoclaw uses a skill system to dynamically add channels:
...
- [RFC 002](docs/RFC/RFC%20002:%20Devbox%20Control%20Plane.md) - Old architecture (archived)

## Legacy Implementation

The Incus-based implementation from RFC 002 has been archived to the `archive/` directory for reference only.
